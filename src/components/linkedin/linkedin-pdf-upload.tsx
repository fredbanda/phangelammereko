  ...
  const handleUpload = useCallback(async () => {
    ...
    try {
      ...
      setUploadState((prev) => ({
        ...
        uploading: false,
        progress: 0,
        error: "Upload failed. Please log in to run this test.",
      }));

      toast.error("Upload failed. Please log in to run this test.", {
        position: "top-right",
      });
      
      router.push(`/sign-in?redirectUrl=/linkedin-optimizer`);
    ...
    <div className="space-y-6">
      ...
      <div className="bg-muted/50 rounded-lg p-4">
        ...
        <ol className="text-muted-foreground list-inside list-decimal space-y-1 text-sm">
          ...
          <li>
            Click <span className="font-semibold">More</span> in your profile
            section
          </li>
          <li>
            Select <span className="font-semibold">Save to PDF</span>
          </li>
