...
export default function CheckoutFlow() {
  ...
  // ✅ NEW: Call the API route instead of accessing env vars directly
  async function handlePremiumClick() {
    try {
      ...
      // Map urgency to package type (API expects uppercase)
      ...
      const packageType = packageTypeMap[requirements.urgency];
      ...
      toast.error(
        error instanceof Error ? error.message : "Something went wrong while creating the checkout session",
        { position: "top-right" }
      );
    } finally {
      setLoading(false);
